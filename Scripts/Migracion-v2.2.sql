...
VALUES('admin', LOWER(CONVERT(char(100),HASHBYTES('SHA2_256', 'w23e'),2)), 1, GETDATE(), 0, 0)

INSERT INTO Usuarios(username, password, habilitado, alta_logica, intentos_fallidos, debe_cambiar_pass)
VALUES('sa', LOWER(CONVERT(char(100),HASHBYTES('SHA2_256', 'gestiondedatos'),2)), 1, GETDATE(), 0, 0)
